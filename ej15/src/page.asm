...
EXTERN __INICIO_RAM_BSS_TAREA_1
EXTERN __INICIO_RAM_BSS_TAREA_2
...
EXTERN __LONGITUD_BSS_TAREA_1
EXTERN __LONGITUD_BSS_TAREA_2
...
%define ATRIBUTOS_DIRECTORIO    0x7
%define ATRIBUTOS_TABLA_S_R_P   0x1
%define ATRIBUTOS_TABLA_S_RW_P  0x3
%define ATRIBUTOS_TABLA_US_R_P  0x5
%define ATRIBUTOS_TABLA_US_RW_P 0x7
...
USE32
  ...
  push  __DIR_FISICA_PAGE_TABLES_0
  push  ATRIBUTOS_DIRECTORIO
  push  ATRIBUTOS_TABLA_S_RW_P
...
;---------------------------------------------------------------------------------------------------
  ...
  push  ATRIBUTOS_DIRECTORIO
  push  ATRIBUTOS_TABLA_US_RW_P
  push  __LONGITUD_BSS_TAREA_1
  push  __DIR_FISICA_BSS_TAREA_1
  push  __INICIO_RAM_BSS_TAREA_1
...
;---------------------------------------------------------------------------------------------------
  ...
  push  ATRIBUTOS_DIRECTORIO
  push  ATRIBUTOS_TABLA_US_RW_P
  push  __LONGITUD_BSS_TAREA_2
  push  __DIR_FISICA_BSS_TAREA_2
  push  __INICIO_RAM_BSS_TAREA_2
