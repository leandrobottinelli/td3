...
EXTERN __INICIO_RAM_TAREA_1
EXTERN __INICIO_ROM_TAREA_1
...
nucleos:   
  ...
  push __INICIO_ROM_TAREA_1
  push __INICIO_RAM_TAREA_1
  push __LONGITUD_TAREA_1
